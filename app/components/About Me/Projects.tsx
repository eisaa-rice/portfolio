...
const Projects = () => {
  ...
  const y1 = useTransform(scrollY, [450, 1250], [300, -300]); // Adjust the -50 value to change the parallax depth
  const rotate1 = useTransform(scrollY, [450, 1250], [5, -5]);

  return (
    <div className="min-h-[3000px] w-full flex flex-col items-center justify-start gap-y-32">
